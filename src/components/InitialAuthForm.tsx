...
interface InitialAuthFormProps {
  onPhoneSubmit: (phone: string) => void;
  onGoogleAuth: () => void;
  isLoading: boolean;
}

const InitialAuthForm = ({ onPhoneSubmit, onGoogleAuth, isLoading }: InitialAuthFormProps) => {
  const [phone, setPhone] = useState('');

  const handlePhoneSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (phone.trim()) {
      // Ensure phone starts with +91 if it doesn't already
...
export default InitialAuthForm;